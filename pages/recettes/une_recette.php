<body>
    ...
    <a class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400"> <?php include("php/requete/recette/liste_ingredient.php"); ?></p>
        <h6 class="mt-2 mb-2 text-2xl tracking-tight text-gray-900 dark:text-white">Preparation : </h6>
        <p class="font-normal text-gray-700 dark:text-gray-400"> Difficulté : <?php include("php/requete/recette/difficulte.php"); ?></p>
        <p class="font-normal text-gray-700 dark:text-gray-400">Temps de préparation : <?php include("php/requete/recette/temps_preparation.php"); ?></p>
        <p class="font-normal text-gray-700 dark:text-gray-400">Temps de cuisson : <?php include("php/requete/recette/temps_cuisson.php"); ?></p>
        <p class="font-normal text-gray-700 dark:text-gray-400">Étapes de la recette : <?php include("php/requete/recette/etape_recette.php"); ?></p>
        ...
        <a class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h6 class="mt-2 mb-2 text-2xl tracking-tight text-gray-900 dark:text-white">Espace commentaire : </h6>
                ...
                <?php
                    ...
                    include("php/requete/commentaire/ecrire_commentaire.php");

                    }
                }
                ?>
            <?php include("php/requete/commentaire/espace_commentaires.php"); ?> 
